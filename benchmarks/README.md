...
`semgrep-comparison/rules.yml` is an original minimal ruleset written for these corpora (no third-party rule text copied). Where Semgrep runs (Linux/macOS), compare with:
